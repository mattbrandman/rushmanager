...
from authentication.models import BrotherUser, Settings
...
class ChapterAdminForm(ModelForm):
    ...
    def save(self, commit=True):
        ...
        data = {
            'national_organization': self.cleaned_data['national_organization'],
            'chapter_name': self.cleaned_data['chapter_name']
        }
        tenant = Organization(domain_url=data['national_organization'] + data['chapter_name'] + '.com',
                              schema_name=data['national_organization'] + data['chapter_name'],
                              national_organization=data['national_organization'],
                              chapter_name=data['chapter_name'])
        tenant.save()
        connection.set_schema(tenant.schema_name)
        new_settings = Settings()
        user = BrotherUser(email=self.cleaned_data['email'], settings=new_settings)
