...
class UpdateForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'primary_contact'].queryset = get_user_model().objects.all().order_by('email')
        self.fields[
            'secondary_contact'].queryset = get_user_model().objects.all().order_by('email')
        self.fields[
...
class CreateRushForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'primary_contact'].queryset = get_user_model().objects.all()
        self.fields[
            'secondary_contact'].queryset = get_user_model().objects.all()
        self.fields[
            'rush_period'].queryset = self.request.user.organization.rushperiod_set.all()
